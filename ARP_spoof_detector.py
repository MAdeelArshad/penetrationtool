...
"""
    This method detect sniff the packets on destination and source ip address.
"""
...
def process_sniffed_packet(packet):
    if packet.haslayer(scapy.ARP) and packet[scapy.ARP].op == 2:
        try:
            ...
            if real_mac != response_mac:  # this condition check either both of the mac address match or not
