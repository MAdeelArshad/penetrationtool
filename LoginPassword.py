...
"""
    This method show the options to user 
    to specified task in menu. 
"""
...
"""
    This method Enroll the new user 
    so that new user perform task in 
    application.
"""
...
"""
    This method can allow the user to 
    change their credentials like password 
    and username 
"""
...
"""
    This method Allow the admin to see the 
    details of all users in application.
"""
...
"""
    This method allow the interface to enter 
    the details of user name and password and
    then this method will validate the credentials
"""
